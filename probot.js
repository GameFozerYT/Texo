...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('day')) {
    ...
    profile[message.author.id].credits += 100000000000000000
     message.channel.send(`**${message.author.username} you collect your \`100000000000000000\` :dollar: daily pounds**`)
} else {
